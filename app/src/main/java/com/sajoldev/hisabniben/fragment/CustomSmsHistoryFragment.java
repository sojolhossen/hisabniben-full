...
public class CustomSmsHistoryFragment extends Fragment {
    ...
    public static CustomSmsHistoryFragment newInstance() {
        return new CustomSmsHistoryFragment();
    }
    ...
    private void showSmsDetails(SmsHistory sms) {
        ...
        tvType.setText("Custom SMS (কাস্টম)");
    ...
    private void loadCustomSmsHistory() {
        if (userId == null) {
        ...
        db.collection("sms_history")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    if (list.isEmpty()) {
                        tvEmpty.setText("এখনো কোনো Custom SMS পাঠানো হয়নি");
                        tvEmpty.setVisibility(View.VISIBLE);
                        rvSmsHistory.setVisibility(View.GONE);
                    } else {
